...
<body >
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
            <p class="text-center titulo"> Agenda de Contactos hecha en PHP</p>
            <p class="text-center descripcion">Agenda de contantos tecnologia utilizada en el fronten, Framework 
                <b>Bootstrap</b>  la teconologia backend esta realizada en el lenguaje de <b>PHP</b> adicinal mente utilizamos tecnologias como 
                la libreria <b>AJAX y Github    </b> como controlador de verciones. el codigo lo puedes encontrar en <a href="#">Github_Agenda</a> </p>
            </div>
            <div class="col-sm-4">
                <div>
        ...
        <div class="row">
            <div class="col">
                ...
                <strong>Copyright &copy; 2018 <a href="#" target="_blank">Allan Sanchez</a>.</strong>
